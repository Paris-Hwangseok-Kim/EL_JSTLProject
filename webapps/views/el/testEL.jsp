...
<body>
	...
	<h3>
		&lt;%= %&gt;, request.getAttribute("OOO") 자바 코드들을<br> 더욱 사용이 간편하게
		만드는 기술로 JSP.2.0 버전부터 추가되었다.
	</h3>
	...
	<form action="testELResult.jsp" method="post">
		...
		<h3>
			성별 : <input type="radio" name="gender" value="M" /> 남성 &nbsp; <input
		...
		<h3>
			좋아하는 색상 : <select name="color">
				...
				<option value="hotpink">분홍색</option>
			</select>
		</h3>
